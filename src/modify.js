...
const readFilesParallel = () => {
  const part1 = fs.readFile("src/data/story-part-1.txt", "utf-8");
  const part2 = fs.readFile("src/data/story-part-2.txt", "utf-8");
  const part3 = fs.readFile("src/data/story-part-3.txt", "utf-8");
  const part4 = fs.readFile("src/data/story-part-4.txt", "utf-8");
